sap.ui.define([
	...
	return BaseController.extend("so.salesorder.controller.Master", {
		...
		onInit : function () {
			...
			this._oGroupFunctions = {
				Netwr : function(oContext) {
					var iNumber = oContext.getProperty('Netwr'),
						key, text;
					if (iNumber <= 20) {
						key = "LE20";
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("Kunnr", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "so.salesorder.view.ViewSettingsDialog",
					controller: this
